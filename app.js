...
function generatePDF() {
    loadPDFLibrary(function () {
        ...
        bukitBarisArr = Array.from(bukitBarisSet)
            ...
            .sort((a, b) => {
                const compBukit = (parseInt(a.bukit) || a.bukit).toString().localeCompare((parseInt(b.bukit) || b.bukit).toString(), 'id', {
                    numeric: true
                });
                if (compBukit !== 0) return compBukit;
                return (parseInt(a.baris) || a.baris).toString().localeCompare((parseInt(b.baris) || b.baris).toString(), 'id', {
                    numeric: true
                });
            });
        pokokArr = Array.from(pokokSet)
            .sort((a, b) => (parseInt(a) || a).toString().localeCompare((parseInt(b) || b).toString(), 'id', {
                numeric: true
            }));
